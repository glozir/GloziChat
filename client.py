...
def setup_root() -> tk.Tk:
    ...
    scrollb.grid(row=0, column=1, rowspan=2, sticky=tk.NS)
    ...
    active_users.grid(row=1, column=2, sticky='ews')
    users = tk.Frame(root, width=15, borderwidth=3, background=DISCORD_DARK_BLUE)
    users.grid(row=0, column=2, sticky='nsew')
...
if __name__ == "__main__":
    ...
    check_server_connection_thread.daemon = True
    check_server_connection_thread.start()
